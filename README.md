...
- Self: stats, task animations, ladder cooldown, unlimited meetings, chat theme/font customization
- ESP: see roles, ghosts, player info, disguises, task arrows, votes, lobby info
- Roles: fake roles, fake alive, kill aura/reach, vanish, tracking, vent and sabotage tweaks
- Players: player targeted actions and info
- Ship: door control, meetings, body reports, fake tasks
...
- Animations: task and movement animation tweaks
- Console: in game event log (kills, vents, sabotages, meetings, ejections, votes, votekicks, chat, disconnects, joins, and more)
- Host: host only tools (disable sabotages, meetings, and cameras, pre-game role forcing, disco party, level blocking)
...
- Troll: troll stuff such as disabling vents or the door troller, nothing more
- Votekick: votekick handling
...
- Anticheat: RPC validation and known mod detection
- Dating Shit: lobby browser filters for dating lobbies
- Modes: RGB, stealth, panic, and streamer modes
- Settings/Config: save and load your full toggle and slider profile, window position memory
...
Use Save to Profile / Load from Profile in the Config tab to persist your toggles and sliders between sessions. Enable AutoLoadProfile in the BepInEx config to load it automatically on game startup.
